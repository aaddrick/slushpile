...
Điều đó định hình mọi quyết định được ghi lại ở đây. Một quy tắc mà pipeline này
muốn được thực thi thì phải sống sót qua việc bị một mô hình đang quá tải diễn
đạt lại, vì không có trình thông dịch nào để cưỡng chế nó. Một dữ kiện mà
pipeline cần thì phải nằm trong một tệp mà mô hình thực sự sẽ đọc, vì không có
cơ sở dữ liệu nào để truy vấn.

| Tệp | Nội dung |
| --- | --- |
| [pipeline.md](pipeline.md) | Năm sơ đồ, phần chú giải, và mỗi giai đoạn làm gì. |
| [the-review.md](the-review.md) | Vì sao phần đánh giá có hình dạng như hiện nay: giai đoạn mù, thứ tự phái đi, người gác cổng, và trần ba vòng. |
| [scoring.md](scoring.md) | Neo theo nhóm ứng viên, phán quyết theo từng kênh, các hạng, và tiêu chí loại. |
| [memory-and-calibration.md](memory-and-calibration.md) | Không gian làm việc như một bộ nhớ bền vững, các đường ghi ngược, và cách các dự đoán được kết quả thật sửa lại. |
...
| [generated-surfaces.md](../../../../docs/architecture/generated-surfaces.md) | Vì sao có sáu bề mặt cùng mô tả pipeline này mà không bề mặt nào sở hữu một dữ kiện. |
