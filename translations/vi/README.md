<p align="center">
  <img src="../../.github/assets/hero.png" alt="Slushpile: một cuộc tìm việc đối kháng có trí nhớ. 7 tác nhân cố loại bạn trước khi một nhà tuyển dụng kịp làm điều đó, và những gì chúng tìm ra thì bạn giữ lại. Những gì bạn giữ lại: profile.md, mọi tuyên bố sự kiện; preferences.yaml, lương thưởng, địa điểm và ràng buộc; stories.md, bốn đến tám câu chuyện kể được; job_search.md, kết quả thực tế để hiệu chỉnh. Viết một lần, mọi giai đoạn đều đọc, mọi vòng đánh giá đều cập nhật. 7 người đánh giá: người sàng lọc nhanh, chuyên viên phân tích yêu cầu, trình mô phỏng ATS, người đọc đã mệt, chuyên viên phân tích nhóm ứng viên, quản lý tuyển dụng, người phản biện. 5 người đánh giá song song, mù với nhau, rồi tổng hợp, rồi một tác nhân có nhiệm vụ lật ngược kết quả đó." width="100%">
</p>
